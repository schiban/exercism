...
public static class LogAnalysis 
{
    ...
    public static string SubstringAfter(this string message, string delimeter)
        => message.Split(delimeter).Last();

    // TODO: define the 'SubstringBetween()' extension method on the `string` type
    public static string SubstringBetween(this string message, string leftSquareBracket, string rightSquareBracket)
        => message.Split(rightSquareBracket).First().Split(leftSquareBracket).Last();
